...
function resetCheckboxesPopupContacts() {
   for (let i = 0; i < allUsersAndContacts.lenght; i++) {
      document.getElementById(`popupAssignedToCheckboxContacts${i}`).src =
         "https://dennis-ertel.developerakademie.net/projects/join/Join/assets/img/addTask_rectangle.png";
   }
}
