...
function changeAssingnChangeTask(assignCount) {
   ...
   if (img.src == "https://dennis-ertel.developerakademie.net/projects/join/Join/assets/img/addTask_rectangle.png") {
      currentAssigned.splice(assignCount, 1, allUsersAndContacts[assignCount].second_name);
      img.src = "assets/img/checkbox.png";
   } else if (img.src == "https://dennis-ertel.developerakademie.net/projects/join/Join/assets/img/checkbox.png") {
